  ...
  try {
    ...
    const campaign = await prisma.campaign.create({
      data: {
        ...
        audienceStatus: input.audienceStatus ?? "",
        audienceTags: input.audienceTags ?? "",
        audienceSearch: input.audienceSearch ?? "",
        audienceChannel: input.audienceChannel ?? "",
        audienceLimit: input.audienceLimit ?? undefined,
